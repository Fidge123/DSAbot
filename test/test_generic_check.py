...
class TestGenericCheck(TestCase):
    ...
    def test_parse_with_comment(self):
        ...
        gc = GenericCheck(self.author, "20 + 1 - 4 can I put anything here? 🤔")
    ...
    def test_parse_with_other_commands(self):
        ...
        # with self.assertRaises(ValueError):
        #     GenericCheck(self.author, "!13,13,13@13+3 Foobar")
        # with self.assertRaises(ValueError):
        #     GenericCheck(self.author, "!3w6")
        # with self.assertRaises(ValueError):
        #     GenericCheck(self.author, "12d12+2")
