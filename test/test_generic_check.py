...
class TestGenericCheck(TestCase):
    ...
    def test_parse_with_prefix(self):
        ...
        with self.assertRaises(ValueError):
            GenericCheck("!!13 1", "@TestUser")
        with self.assertRaises(ValueError):
            GenericCheck("!  1 13", "@TestUser")
        with self.assertRaises(ValueError):
            GenericCheck("!?4", "@TestUser")
        with self.assertRaises(ValueError):
            GenericCheck("#2,2,2", "@TestUser")

    def test_parse_with_large_numbers(self):
        gc = GenericCheck("1337", "@TestUser")
    ...
    def test_parse_with_comment(self):
        ...
        gc = GenericCheck("!12,12-6 lolololol", "@TestUser")
        self.assertEqual(gc.data["attributes"], [12, 12])
    ...
    def test_parse_with_other_commands(self):
        with self.assertRaises(ValueError):
            GenericCheck("d3", "@TestUser")
        with self.assertRaises(ValueError):
            GenericCheck("note:foobar", "@TestUser")
        with self.assertRaises(ValueError):
            GenericCheck("SUMMON", "@TestUser")
        with self.assertRaises(ValueError):
            GenericCheck("BEGONE", "@TestUser")
        with self.assertRaises(ValueError):
            GenericCheck("DIE", "@TestUser")

        # Careful, these are not None. Execution order matters!
        # with self.assertRaises(ValueError):
        #     GenericCheck("!13,13,13@13+3 Foobar", "@TestUser")
        # with self.assertRaises(ValueError):
        #     GenericCheck("!3w6", "@TestUser")
        # with self.assertRaises(ValueError):
        #     GenericCheck("12d12+2", "@TestUser")

    @patch("random.randint", new_callable=MagicMock())
    def test_end2end(self, mock_randint: MagicMock):
        mock_randint.return_value = 8
        gc = GenericCheck("1", "@TestUser")
        self.assertEqual(gc.data["attributes"], [1])
    ...
    def test_end2end_modifier(self, mock_randint: MagicMock):
        ...
        gc = GenericCheck("11,13,13-2 Sinnesschärfe", "@TestUser")
    ...
    def test_end2end_impossible(self, mock_randint: MagicMock):
        mock_randint.return_value = 8
        gc = GenericCheck("!111 1337 42 1 1 +1 - 2 -4 🎉", "@TestUser")
    ...
    def test_end2end_crit(self, mock_randint: MagicMock):
        ...
        gc = GenericCheck("!12 15 16 -4 🎉", "@TestUser")
    ...
    def test_end2end_botch(self, mock_randint: MagicMock):
        ...
        gc = GenericCheck("!18 18 19 +3 💥", "@TestUser")
