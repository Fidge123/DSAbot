...
class TestSkillCheck(TestCase):
    def test_parse(self):
        self.assertIsNotNone(SkillCheck("13@2", MockAuthor("TestUser")))
        ...
        self.assertIsNotNone(SkillCheck("2 2, 2, 2,2@1400-2-2-2", MockAuthor("TU")))
        self.assertIsNotNone(SkillCheck("!13 1@2 +1+1 Test", MockAuthor("TestUser")))
    ...
    def test_end2end(self, mock_randint: MagicMock):
        ...
        sc = SkillCheck("11@4", MockAuthor("TestUser"))
        self.assertEqual(sc.data["attributes"], [11])
        ...
        self.assertEqual(sc.data["rolls"].rolls, [9])
        ...
        sc = SkillCheck("!5 6,3, 4,@16 +1+1 -2- 2 🎉-1", MockAuthor("TestUser"))
        self.assertEqual(sc.data["attributes"], [5, 6, 3, 4])
        self.assertEqual(sc.data["SR"], 16)
        self.assertEqual(sc.data["modifier"], -2)
        self.assertEqual(sc.data["comment"], "🎉-1")
        self.assertEqual(sc.data["skill_req"], 26)
        self.assertEqual(sc.data["rolls"].rolls, [9, 9, 9, 9])
        self.assertEqual(sc.data["rolls"].critical_success, False)
        self.assertEqual(sc.data["rolls"].botch, False)
        self.assertEqual(sc.skill_points, -10)
        self.assertEqual(sc.quality_level, 1)
